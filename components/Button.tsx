...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-lux-primary text-white hover:bg-lux-secondary shadow-soft hover:shadow-lg transform hover:-translate-y-0.5",
    secondary: "bg-lux-secondary text-white hover:bg-lux-primary shadow-soft",
    outline: "border border-lux-primary text-lux-primary hover:bg-lux-primary hover:text-white bg-transparent",
